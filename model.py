...
class DictableColumn():
    """Mixin to make jsonifying SQLAlchemy model objects easier"""
    def to_dict(self):
...
class Recipe(DictableColumn, db.Model):
    ...
    def to_dict(self):
        ...
        dirty_dict['owner_avatar'] = self.owner.img_url
        if self.forked_from:
            dirty_dict['forked_from_username'] = self.parent.owner.username
            dirty_dict['forked_from_avatar'] = self.parent.owner.img_url
...
class Experiment(DictableColumn, db.Model):
    ...
    ## planning an experiment - as yet unused
    ...
    def to_dict(self):
        ...
        if self.committer: 
            ...
            dicted['commit_by_avatar'] = self.committer.img_url
        return dicted
